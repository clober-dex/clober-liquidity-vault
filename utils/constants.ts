...
import { riseTestnet, monadPrivateMainnet } from './chains'
...
export const MINTER_ROUTER: { [chainId: number]: Address } = {
  ...
  [riseTestnet.id]: '0x08feDaACe14EB141E51282441b05182519D853D1',
  [monadPrivateMainnet.id]: '0x7B58A24C5628881a141D630f101Db433D419B372',
}
...
export const CHAINLINK_SEQUENCER_ORACLE: { [chainId: number]: Address } = {
  ...
  [riseTestnet.id]: zeroAddress,
  [monadPrivateMainnet.id]: zeroAddress, // L1 no oracle
}
...
export const ORACLE_TIMEOUT: { [chainId: number]: number } = {
  ...
  [riseTestnet.id]: 24 * 3600,
  [monadPrivateMainnet.id]: 24 * 3600,
}
...
export const SAFE_WALLET: { [chainId: number]: Address } = {
  ...
  [monadPrivateMainnet.id]: '0xfb976Bae0b3Ef71843F1c6c63da7Df2e44B3836d',
}
